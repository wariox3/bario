 ...
 * todos": limita la generación a las plantillas marcadas. `mes`/`anio` son
 * requeridos por el backend siempre —son el período de los documentos que se
 * crean—, aunque se envíe una selección explícita.
 */
export interface GenerarRecurrentePayload {
  ...
  /** Plantillas seleccionadas en el listado. */
