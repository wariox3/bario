...
import { TRASLADO_CONFIG } from './documentos/traslado/traslado.config';
 ...
 * nuevo: crear su carpeta bajo `documentos/<id>/` con su config, constantes y
 * rutas, y agregarlo aquí — el form y la ficha ya los aporta
...
export const INVENTARIO_CONFIG: ModuleConfig = {
  ...
  iconClass: 'pi pi-box',
  documents: [ENTRADA_CONFIG, SALIDA_CONFIG, TRASLADO_CONFIG],
};
