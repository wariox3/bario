...
/**
 * Valores crudos del formulario de un movimiento de inventario —entrada, salida
 * y traslado comparten cabecera— (`form.getRawValue()`).
 *
 ...
 */
export interface MovimientoFormRawValue {
