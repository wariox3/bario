...
/**
 * Rutas de **Nota crédito de venta**.
 *
 ...
 * nota débito. Lo único que los distingue es el `documento_tipo` del config.
 *
 * El `activeDocumentResolver('nota-credito')` deja la config en
 ...
 */
export const NOTA_CREDITO_ROUTES: Route[] = [
  {
    path: '',
    resolve: { document: activeDocumentResolver('nota-credito') },
    children: [
