 ...
 *
 * General no tiene documentos propios: reusa los de Venta, Compra y Cartera para
 * que la facturación y el recaudo estén a mano sin salir del módulo. Es el mismo
...
export const GENERAL_CONFIG: ModuleConfig = {
  ...
  iconClass: 'pi pi-cog',
  documents: [FACTURA_VENTA_CONFIG, FACTURA_COMPRA_CONFIG, PAGO_CONFIG],
};
