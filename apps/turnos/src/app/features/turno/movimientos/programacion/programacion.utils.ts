import { fromIsoDate } from '@reddoc/core';
import type { ProgramacionVigencia } from './programacion.model';

// `toProgramacionFecha`, `esColumnaFestiva` y `esColumnaSabado` viven ahora en
// `@reddoc/core` (`lib/calendario`): las comparte el modal de afectación del ERP.
